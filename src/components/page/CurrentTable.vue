...
<script>
import { getCurrentItemData } from '../../api/index';
import { delCurrentItemData } from '../../api/index';
import { searchCurrentItemData } from '../../api/index';
import { updateCurrentItemData } from '../../api/index';
export default {
    name: 'basetable',
    data() {
        return {
    ...
    methods: {
        ...
        handleSearch() {
            ...
            if(this.query.item_name === '')
            {
                ...
                searchCurrentItemData(this.query).then(res => {
                console.log(res.data);
                this.tableData = res.data
                });
            }
        ...
        handleDelete(index, row) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                .then(() => {
                    delCurrentItemData(row).then(res => {
                });
        ...
        // 保存编辑
        saveEdit() {
            updateCurrentItemData(this.form).then(res => {
                console.log(res.data);
            });
